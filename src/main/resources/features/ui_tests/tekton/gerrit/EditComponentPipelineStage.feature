Feature: Edit component features gerrit
  ...
  Scenario Outline: Edit created component
    ...
    @UI @TektonGerritUI @EditComponentGerrit
    Examples:
      ...
      | js-antora-app-component-edit | antora_application | ^\[TEST-\d{4}\]:test:.* | EPMDEDPSUP-\d{4}  | EDP_COMPONENT        | EDP_GITTAG-EDP_COMPONENT | EDP_COMPONENT    |
  ...
  Scenario Outline: Edit created pipeline and stage
    ...
    @UI @TektonGerritUI @EditPipelineStageGerrit
    Examples:
      | applicationName               | secondApplicationName            | codeLanguage      | pipelineName    | stageName | defaultBranch | secondDefaultBranch |
      | beego-app-pipeline-stage-edit | beego-sc-app-pipeline-stage-edit | beego_application | beego-test-pipe | dev       | main          | master              |
