Feature: Edit component features github
  ...
  Scenario Outline: Edit created component
    ...
    @UI @TektonGithubUI @EditComponentGithub
    Examples:
      ...
      | js-express-lib-component-edit | express_library | ^\[TEST-\d{4}\]:test:.* | EPMDEDPSUP-\d{4}  | EDP_COMPONENT        | EDP_GITTAG-EDP_COMPONENT | EDP_COMPONENT    |
  ...
  Scenario Outline: Edit created pipeline and stage
    ...
    @UI @TektonGithubUI @EditPipelineStageGithub
    Examples:
      | applicationName                  | secondApplicationName               | codeLanguage           | pipelineName       | stageName | defaultBranch | secondDefaultBranch |
      | dotnet31-app-pipeline-stage-edit | dotnet31-sc-app-pipeline-stage-edit | dotnet_3_1_application | dotnet31-test-pipe | dev       | main          | master              |
